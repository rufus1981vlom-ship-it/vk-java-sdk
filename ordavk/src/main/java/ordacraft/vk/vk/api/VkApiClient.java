...
public class VkApiClient {
    ...
    public VkApiClient(String token, String version){ this.token=token; this.version=version; }
    ...
    public JsonObject call(String method, Map<String,String> params) throws IOException, InterruptedException {
        ...
        q.add("access_token="+enc(token)); q.add("v="+enc(version));
    ...
    public boolean removeChatUser(long chatId, long memberId) {
        try { call("messages.removeChatUser", Map.of("chat_id", String.valueOf(chatId), "member_id", String.valueOf(memberId))); return true; }
